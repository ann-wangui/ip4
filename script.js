...
$(document).ready(function() {
    ...
    $('.whatweoffer img.one').click(function() {
      $(".whatweoffer img.one").toggle();
      $(".whatweoffer p.one").toggle();
    });
    $('.whatweoffer p.one').click(function() {
      $(".whatweoffer img.one").toggle();
      $(".whatweoffer p.one").toggle();
    });
    $('.whatweoffer img.two').click(function() {
      $(".whatweoffer img.two").toggle();
      $(".whatweoffer p.two").toggle();
    });
    $('.whatweoffer p.two').click(function() {
      $(".whatweofffer img.two").toggle();
      $(".whatweoffer p.two").toggle();
    });
    $('.whatweoffer img.three').click(function() {
      $(".whatweoffer img.three").toggle();
      $(".whatweoffer p.three").toggle();
    });
    $('.whatweoffer p.three').click(function() {
      $(".whatweoffer img.three").toggle();
      $(".whatweoffer p.three").toggle();
    });
  
    $('.whatweoffer h3').click(function() {
      $(".whatweoffer img.one").toggle();
      $(".whatweoffer p.one").toggle();
    });
    $('.whatweoffer h3').click(function() {
